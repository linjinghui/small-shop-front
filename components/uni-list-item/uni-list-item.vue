<template>
	<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'" class="uni-list-item" @click="onClick">
		<view class="uni-list-item__container">
			...
			<view v-else-if="showExtraIconFont" class="uni-list-item__icon">
				<uni-iconfont :color="extraIcon.color" :size="extraIcon.size" :type="extraIcon.type" />
			</view>
...
<script>
	...
	import uniIconfont from '../uni-iconfont/uni-icon.vue'
